...
clust5 <- read.csv("vol_cluster5.csv")

dir_day3 <- clust5[,-c(1,16,17,19,20)]
...
combined_cmat_mlr3 <- rbind(train_cmat_mlr3$byClass, test_cmat_mlr3$byClass)


file.create("Cluster5 Confusion Matrix mlr3.csv")

write.csv(combined_cmat_mlr3, "Cluster5 Confusion Matrix mlr3.csv")
...
file.create("Cluster4 Confusion Matrix svm3.csv")

write.csv(combined_cmat_svm3, "Cluster4 Confusion Matrix svm3.csv")
...
file.create("Cluster2 Confusion Matrix dt3.csv")

write.csv(combined_cmat_dt3, "Cluster 2 Confusion Matrix dt3.csv")
...
# Least Error Model : mtry - 5, min.node.size = 5, replace= True, sample.fraction = 0.80, rmse = 0.5392
...
file.create("Cluster4 Confusion Matrix RF3.csv")

write.csv(combined_cmat_rf3, "Cluster4 Confusion Matrix RF3.csv")
...
# Best model : mtry - 3, min.node.size = 1, replace = T, sample.fraction = 0.50, rmse = 0.5052
