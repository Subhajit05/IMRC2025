...
pr3 <- clust2[,-c(1,17,18,19,20)]

# data split (train - 80%; test - 20%)

row_index <- sample(nrow(pr3), size = 0.8*nrow(pr3), replace = F )

train_data3 <- pr3[row_index,]

test_data3 <- pr3[-row_index,]
