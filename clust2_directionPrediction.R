...
clust2 <- read.csv("dir_cluster2.csv")

dir_day3 <- clust2[,-c(1,16,17,19,20)]
...
file.create("Cluster2 Confusion Matrix mlr.csv")

write.csv(combined_cmat_mlr, " Cluster2 Confusion Matrix mlr.csv")
...
file.create("Cluster2 Confusion Matrix svm3.csv")

write.csv(combined_cmat_svm3, "Cluster2 Confusion Matrix svm3.csv")
...
# Least Error Model : mtry - 4, min.node.size = 1, replace= True, sample.fraction = 0.63, rmse = 0.5230
...
file.create("Cluster2 Confusion Matrix RF3.csv")

write.csv(combined_cmat_rf3, "Cluster2 Confusion Matrix RF3.csv")
...
# Best model : mtry - 5, min.node.size = 5, replace = F, sample.fraction = 0.63, rmse = 0.502
